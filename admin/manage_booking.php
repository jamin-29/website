...
<div class="admin-container">
    <aside class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li><a href="manage_booking.php" class="active"><i class="fa-solid fa-calendar-check"></i> Manage Bookings</a></li>
    ...
    <main class="dashboard-content">
        <header class="dashboard-header">
            ...
            <a href="add_booking.php" class="add-btn"><i class="fa-solid fa-plus"></i> Add Booking</a>
        </header>
        ...
        <form method="GET" class="search-form">
            ...
            <?php if($search): ?>
                <a href="manage_booking.php" class="clear-btn">Clear</a>
            <?php endif; ?>
        </form>
                    ...
                    <?php if(mysqli_num_rows($result) > 0): ?>
                        <?php while($row = mysqli_fetch_assoc($result)): ?>
                            <tr>
                                ...
                                <td class="actions">
                                    <a href="edit_booking.php?id=<?= $row['id'] ?>" class="edit-btn"><i class="fa-solid fa-pen"></i></a>
                                    <a href="manage_booking.php?delete=<?= $row['id'] ?>" class="delete-btn" onclick="return confirm('Are you sure you want to delete this booking?');"><i class="fa-solid fa-trash"></i></a>
                                </td>
                            </tr>
                        <?php endwhile; ?>
                    <?php else: ?>
                        <tr>
                            <td colspan="9" style="text-align:center; color:#777;">No bookings found.</td>
                        </tr>
                    <?php endif; ?>
                </tbody>
            </table>
